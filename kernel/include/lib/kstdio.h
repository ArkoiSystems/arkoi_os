 ...
 * and stores it in the provided buffer. The format string can include placeholders for various data types, such as
 * integers, strings, and characters, which will be replaced by the corresponding arguments.
 *
 ...
 * string, and stores it in the provided buffer. The format string can include placeholders for various data types, such
 * as integers, strings, and characters, which will be replaced by the corresponding arguments.
 *
 * @param buffer The buffer where the formatted string will be stored.
 * @param size   The maximum number of characters to be written to the buffer, including the null terminator.
 * @param format The format string, similar to printf in C.
 ...
 *
 * This function takes a format string and a va_list of arguments, formats the output according to the format string,
 * and prints it to the console. The format string can include placeholders for various data types, such as integers,
 * strings, and characters, which will be replaced by the corresponding arguments.
 *
 * @param format The format string, similar to printf in C.
 * @param args   A va_list of arguments to be formatted according to the format string.
 ...
 *
 * This function takes a format string and a variable number of arguments, formats the output according to the format
 * string, and prints it to the console. The format string can include placeholders for various data types, such as
 * integers, strings, and characters, which will be replaced by the corresponding arguments.
 *
 * @param format The format string, similar to printf in C.
 * @param ...    Additional arguments to be formatted according to the format string.
